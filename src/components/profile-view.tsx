...
export const ProfileView = () => {
  ...
  const fullName = riderData
    ? `${riderData.firstName || ""} ${riderData.lastName || ""}`.trim() || "Rider"
    : "Rider";
    ...
    <section className="container mx-auto px-4 py-12 min-h-screen">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="mb-2 leter-spacing-1 text-4xl md:text-5xl font-bold">
              My Profile
            </h1>
            <p className="leter-spacing-1 text-lg text-gray-600">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6 mb-8 pb-8 border-b border-gray-200">
            ...
            <div className="flex-1 text-center md:text-left">
              <h2 className="text-3xl font-bold text-gray-800 mb-2">{fullName}</h2>
              {riderData?.email && (
