...
export const EditNewsForm = ({ newsId }: EditNewsFormProps) => {
    ...
    async function fetchNews() {
      try {
        ...
        if (data) {
          ...
          formik.setValues(getInitialValues(data));
        }
      } catch (err) {
  ...
  useEffect(() => {
    if (formik.values.title && !slugManuallyEdited && !formik.values.slug) {
  ...
  return (
    <section className="container mx-auto px-4 py-6 md:py-12 min-h-screen">
      <div className="mb-6">
        <NavigationLink
          href={`/news/${originalSlug}`}
          className="inline-flex items-center text-[#37007d] hover:text-[#5a00b8] transition-colors mb-4"
        >
        ...
        >
          ...
          <div className="mb-4 md:mb-6">
            ...
            <p className="text-gray-500 text-xs mt-1">
              URL-friendly identifier. Changing this will change the article URL.
            </p>
            {formik.errors.slug && (
              <p className="text-red-500 text-xs italic mt-1">
                {formik.errors.slug}
          ...
          <div className="mb-4 md:mb-6">
            ...
            <p className="text-gray-500 text-xs mt-1">
              Use Markdown syntax for formatting (headers, bold, lists, links, etc.)
            </p>
          ...
          <div className="mb-4 md:mb-6">
            ...
            <div className="text-sm text-gray-600 mb-2">Or enter image URL:</div>
            <input
              className={`shadow appearance-none border ${
          ...
          <div className="flex justify-center gap-4 mt-6 md:mt-8">
            ...
            <Button
              ...
              className="w-full md:w-auto px-6 md:px-8 py-2 md:py-3 text-sm md:text-base"
            >
              {disabled ? <Loader /> : "Update News Article"}
            </Button>
          </div>
        </form>
      </div>
